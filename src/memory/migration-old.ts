...
export class MemoryMigration {
   ...
   */
  private async _migrateAgents(oldDb: Database.Database, swarmMemory: SwarmMemory): Promise<void> {
    try {
   ...
   * Migrate tasks table
   */
  private async _migrateTasks(oldDb: Database.Database, swarmMemory: SwarmMemory): Promise<void> {
    try {
   ...
   * Migrate neural patterns
   */
  private async _migratePatterns(oldDb: Database.Database, swarmMemory: SwarmMemory): Promise<void> {
    try {
   ...
   * Migrate consensus data
   */
  private async _migrateConsensus(oldDb: Database.Database, swarmMemory: SwarmMemory): Promise<void> {
    try {
  ...
  private _determineNamespace(type: string): string {
  ...
  private _calculateTTL(type: string): number | null {
 ...
 */
export async function runMigration(options: Partial<MigrationOptions> = {}): Promise<MigrationResult> {
