...
export async function taskCommand(subArgs: string[], flags: TaskFlags): Promise<void> {
...
async function createTask(subArgs: string[], flags: TaskFlags): Promise<void> {
  ...
  const priority = getFlag(subArgs, '--priority') || flags.priority || '5';
...
async function listTasks(subArgs: string[], flags: TaskFlags): Promise<void> {
  const filter = getFlag(subArgs, '--filter') || flags.filter;
...
async function showTaskStatus(subArgs: string[], flags: TaskFlags): Promise<void> {
...
async function executeWorkflow(subArgs: string[], flags: TaskFlags): Promise<void> {
...
async function manageCoordination(subArgs: string[], flags: TaskFlags): Promise<void> {
