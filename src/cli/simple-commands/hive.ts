...
// Type definitions
export type Topology = 'hierarchical' | 'mesh' | 'ring' | 'star';
export type ConsensusType = 'quorum' | 'unanimous' | 'weighted' | 'leader';

export interface HiveFlags {
  help?: boolean;
  h?: boolean;
  topology?: Topology;
...
export async function hiveCommand(args: string[] = [], flags: HiveFlags = {}): Promise<void> {
