...
interface McpFlags {
  ...
  category?: string;
  examples?: boolean;
  autoOrchestrator?: boolean;
  daemon?: boolean;
  stdio?: boolean;
  port?: number;
  host?: string;
  'enable-neural'?: boolean;
  'enable-wasm'?: boolean;
}

export async function mcpCommand(subArgs: string[], flags: McpFlags): Promise<void> {
...
async function showMcpStatus(subArgs: string[], flags: McpFlags): Promise<void> {
...
async function startMcpServer(subArgs: string[], flags: McpFlags): Promise<void> {
  ...
  if (stdio) {
    ...
    try {
      ...
      const mcpServerPath = path.join(__dirname, '../../mcp/mcp-server.ts');
...
async function stopMcpServer(subArgs: string[], flags: McpFlags): Promise<void> {
...
async function listMcpTools(subArgs: string[], flags: McpFlags): Promise<void> {
...
async function manageMcpAuth(subArgs: string[], flags: McpFlags): Promise<void> {
...
async function showMcpConfig(subArgs: string[], flags: McpFlags): Promise<void> {
