...
export class RealTimeMonitor extends EventEmitter {
  ...
  private setupEventHandlers(): void {
    ...
    this.eventBus.on("task:started", (data: unknown) => {
      if (this.isTaskStartedData(data)) {
    ...
    this.eventBus.on("system:resource-update", (data: unknown) => {
      if (this.isSystemMetricsData(data)) {
        this.updateSystemMetrics(data);
      }
    });

    this.eventBus.on("swarm:metrics-update", (data: unknown) => {
      if (this.isSwarmMetricsUpdateData(data)) {
  ...
  private isAgentMetricsUpdateData(
    data: unknown
  ): data is { agentId: string; metrics: AgentMetrics } {
    return (
      typeof data === "object" &&
      data !== null &&
      "agentId" in data &&
  ...
  private isAgentStatusData(
    data: unknown
  ): data is { agentId: string; from: string; to: string } {
    return (
      typeof data === "object" &&
      data !== null &&
      "agentId" in data &&
  ...
  private isTaskStartedData(
    data: unknown
  ): data is { taskId: string; agentId: string } {
    return (
      typeof data === "object" &&
      data !== null &&
      "taskId" in data &&
  ...
  private isTaskCompletedData(
    data: unknown
  ): data is { taskId: string; duration: number } {
    return (
      typeof data === "object" &&
      data !== null &&
      "taskId" in data &&
  ...
  private isTaskFailedData(
    data: unknown
  ): data is { taskId: string; error: string } {
    return (
      typeof data === "object" &&
      data !== null &&
      "taskId" in data &&
  ...
  private isSystemMetricsData(data: unknown): data is Partial<SystemMetrics> {
    return typeof data === "object" && data !== null;
  }

  private isSwarmMetricsUpdateData(
    data: unknown
  ): data is { metrics: SwarmMetrics } {
    return (
      typeof data === "object" &&
      data !== null &&
      "metrics" in data &&
